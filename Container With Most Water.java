...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.maxWater(new int[]{1, 5, 4, 3}));        // Output: 6
        System.out.println(sol.maxWater(new int[]{3, 1, 2, 4, 5}));     // Output: 12
        System.out.println(sol.maxWater(new int[]{2, 1, 8, 6, 4, 6, 5, 5})); // Output: 25
    }
}
